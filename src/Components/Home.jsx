    ...
    <div className="bg-white">
      ...
      <Banner/>
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <a
                href="https://trybe201.com/trybeRegis/index.php"
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-normal tracking-tight text-gray-900 sm:text-6xl">
              Embark on Your <span className='text-indigo-900'>Tech</span> Journey With Us
            </h1>
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="https://trybe201.com/trybeRegis/index.php" className="text-sm font-semibold leading-6 text-gray-900 flex items-center">
  Our Courses <FaCirclePlay className='text-indigo-600 ml-1 text-xl' />
</a>
